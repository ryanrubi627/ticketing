                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-primary accpt-btn">Logs</a>
                            <a href="#" class="btn btn-primary accpt-btn">Drop</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <input type = 'submit' class="btn btn-primary" value = "Reopen" id="sbmt-reopen-tckt">
        </div>
      </div>
